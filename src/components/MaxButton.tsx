...
const MaxButton = ({ phoneNumber = "+79503171377" }: MaxButtonProps) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-20 right-4 sm:bottom-24 sm:right-6 z-40 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white p-3 sm:p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 animate-fade-in group"
